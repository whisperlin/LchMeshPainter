        ...
        if (envMap != null)
        {
            ...
            if (GUILayout.Button("Calc"))
            {
                if (envMap != null)
                {
                    ...
                    Shader.SetGlobalVector("_New_SHAr", coefficients[0]);
                    Shader.SetGlobalVector("_New_SHAg", coefficients[1]);
                    Shader.SetGlobalVector("_New_SHAb", coefficients[2]);
                    Shader.SetGlobalVector("_New_SHBr", coefficients[3]);
                    Shader.SetGlobalVector("_New_SHBg", coefficients[4]);
                    Shader.SetGlobalVector("_New_SHBb", coefficients[5]);
                    Shader.SetGlobalVector("_New_SHC", coefficients[6]);
                }
